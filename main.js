...
let person_name = "Rubab Arshad Qureshi";
//in lowercase
...
let quote = "A person who never made amistake never tried anything new .";
...
let names = ["Areeba", "Laiba", "Mahnoor", "Rubab",];
let Message = "DO you want to take tea?";
...
export function invitedGuest(parameter) {
    let guestsList = ["Mahnoor", "Areeba", "Laiba"];
    let canNotAttend = "Areeba";
    //console.log (`${canNotAttend} + ' ' + cannot attend dinner.`);
    let newGuest = 'Mubashira';
...
let guestlist = ['Malaika', 'Mahnoor', 'Maryam', 'Mubashira', 'Laiba', 'Mehreen'];
...
let placesForVisiting = ['Maldives', 'Saudia Arabia', 'Turkey', 'Switzerland', 'London'];
...
let invitedPeople = ['Malaika', 'Mahnoor'];
let count_invitedPeople = invitedPeople.length;
console.log(`${count_invitedPeople} people will come at the today's dinner.`);
//Task 20
// Think of something you could store in a array. For example, you could make a list of mountains, rivers, countries, cities, languages, or anything else you’d like. Write a program that creates a list containing these items.
let Cities = ['Karachi', 'Islamabad', 'Quetta', 'Lahore', 'Faisalabad'];
...
let cities = ['Karachi', 'Islamabad', 'Quetta', 'Lahore'];
...
let favourite_fruit = ['mango', 'orange', 'grapes', 'pomegranate'];
...
let users = ['admin', 'Einstien', 'Eric', 'Newton', 'Charles'];
...
let current_users = ['admin', 'Eric', 'Sally', 'Bobby', 'gray'];
let new_users = ['admin', 'gray', 'Newzy', 'Lash', 'Bravo'];
...
let favourite_pizzas = ['Creamy Afghani', 'Pepperoni', 'Tikka spicy'];
...
const magician = ['sahar', "subeqa", "sonia"];
...
const magician2 = ['Sahar', 'Subeqa', 'Sonia'];
...
const magician3 = ['Sahar', 'Subeqa', 'Sonia'];
...
const myCar = createCar('toyota', 'corolla', { clour: 'black', year: 2024 });
console.log(myCar);
